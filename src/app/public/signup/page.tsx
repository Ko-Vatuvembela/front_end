...
export default function signUpPage() {
    return (
        <>
            <LayoutPattern backgroundImage="bubu" optionalStyle="mobile:w-[90%] mx-auto" >
                ...
                <form method="post" name='criarcontaform' className="my-8" >
                    ...
                    <Button backgroundColor="bg-primaryBlue" style="w-full" isActive={false} text="Cadastrar" textColor="text-white" hoverColor="hover:bg-secondaryBlue" />
                </form>
